...
@dataclass
class Llama3370BVersatileConfig:
    provider: str
...
class Llama3370BVersatileLLM:
    ...
    def __init__(self, cfg: Dict[str, Any]):
        ...
        self.cfg = Llama3370BVersatileConfig(**cfg)
        ...
        for attempt in range(1, self.cfg.retry_attempts + 1):
            try:
                ...
                if "429" in str(exc) or "rate" in str(exc).lower():
                    ...
                    wait = base_wait
                print(
                    f"[main_llm:llama_3_3_70b_versatile] attempt {attempt} failed: {exc}. "
